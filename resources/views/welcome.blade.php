        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-8">
                ...
                <div class="card mb-3" style="max-width: 540rem;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="https://cdn.pixabay.com/photo/2016/07/20/00/49/thailand-food-1529442_960_720.jpg" style="width: 100%;height: 100%;" alt="กระเพราหมูสับ">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                ...
                <div class="card mb-3" style="max-width: 540rem;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="https://cdn.pixabay.com/photo/2014/11/05/16/00/thai-food-518035_960_720.jpg" style="width: 100%;height: 100%;" alt="ก๋วยเตี๋ยวผัด">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                ...
                <div class="card mb-3" style="max-width: 540rem;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="https://cdn.pixabay.com/photo/2014/10/04/21/03/scrambled-eggs-474086_960_720.jpg" style="width: 100%;height: 100%;" alt="ไข่เจียว">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
